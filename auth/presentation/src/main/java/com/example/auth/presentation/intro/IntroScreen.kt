...
fun IntroScreen(
    ...
    GradientBackground {
        ...
        Column(
            ...
            Text(
                text = stringResource(id = R.string.welcome_to_journey),
                color = MaterialTheme.colorScheme.onBackground,
                fontSize = 20.sp
            )
            Spacer(modifier = Modifier.height(8.dp))
            Text(
                text = stringResource(id = R.string.journey_description),
...
@Composable
fun JourneyLogoVertical(modifier: Modifier = Modifier) {
    Column(
        modifier = modifier,
